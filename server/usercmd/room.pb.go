...
type RoomServerMsgType int32

const (
	RoomServerMsgType_Register RoomServerMsgType = 0 // 房间服务器注册房间信息
	RoomServerMsgType_Update   RoomServerMsgType = 1 // 房间服务器更新房间信息
	RoomServerMsgType_Remove   RoomServerMsgType = 2 // 房间服务器结束信息
)

// Enum value maps for RoomServerMsgType.
var (
	RoomServerMsgType_name = map[int32]string{
		0: "Register",
		1: "Update",
		2: "Remove",
	}
	RoomServerMsgType_value = map[string]int32{
		"Register": 0,
		"Update":   1,
		"Remove":   2,
	}
...
func (x RoomServerMsgType) Enum() *RoomServerMsgType {
	p := new(RoomServerMsgType)
	*p = x
	return p
}

func (x RoomServerMsgType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RoomServerMsgType) Descriptor() protoreflect.EnumDescriptor {
	return file_room_proto_enumTypes[0].Descriptor()
}

func (RoomServerMsgType) Type() protoreflect.EnumType {
	return &file_room_proto_enumTypes[0]
}

func (x RoomServerMsgType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RoomServerMsgType.Descriptor instead.
func (RoomServerMsgType) EnumDescriptor() ([]byte, []int) {
...
type RoomRequest struct {
	...
	Type RoomServerMsgType `protobuf:"varint,1,opt,name=type,proto3,enum=usercmd.RoomServerMsgType" json:"type,omitempty"`
...
func (x *RoomRequest) GetType() RoomServerMsgType {
	if x != nil {
		return x.Type
	}
	return RoomServerMsgType_Register
}
...
var file_room_proto_rawDesc = []byte{
	...
	,
...
var file_room_proto_goTypes = []interface{}{
	(RoomServerMsgType)(0), // 0: usercmd.RoomServerMsgType
...
var file_room_proto_depIdxs = []int32{
	0, // 0: usercmd.RoomRequest.type:type_name -> usercmd.RoomServerMsgType
